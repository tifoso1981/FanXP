...
public class mavs extends BasePage {
	...
	By allFilters = By.xpath("(//button[@class='sc-AxgMl hJVHUe'])[1]");
	By searchFilters = By.xpath("//input[@placeholder]");
	By emailFilter = By.xpath("(//div[@class = 'AddFilters__FilterName-sc-1s8tp9c-3 bARoTT'])[3]");
	...
	By update = By.xpath("//div/button[@class = 'sc-AxgMl Filter__StyledButton-hckeff-11 WFiQB']");
	...
	By countryFilter = By.xpath("(//div[@class = 'AddFilters__FilterName-sc-1s8tp9c-3 bARoTT'])[2]");
	...
	public void clickingUpdateButton() throws InterruptedException {
		Thread.sleep(3000);
	...
	public void clickingAllFiltersToValidateCountry() throws InterruptedException {
		Thread.sleep(3000);
		ElementUtil.doClick(allFilters);
	}
	...
	public void sendingFilterKeyForCountryFilter(String countryFilter) throws InterruptedException {
		Thread.sleep(3000);
